 ...
 * @date 2012-11-06
 */
public class NoScrollMultiColumnListView extends PLA_ListView {
	...
	public NoScrollMultiColumnListView(Context context) {
		super(context);
		init(null);
	}
	...
	public NoScrollMultiColumnListView(Context context, AttributeSet attrs, int defStyle) {
