...
import com.snnu.yefan.fragment.HomeFragment;
import com.snnu.yefan.fragment.MessageFragment;
import com.snnu.yefan.fragment.PersonCenterFragment;
import com.snnu.yefan.fragment.ContactFragment;
import com.snnu.yefan.viewpager.APSTSViewPager;


public class MainActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener{


    private HomeFragment mFirstFragment = null;
    private MessageFragment mSecondFragment = null;
    private ContactFragment mThirdFragment = null;
    private PersonCenterFragment mFourthFragment = null;
    ...
    private void init(){
        mIvCenterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "Center Btn is Clicked.",Toast.LENGTH_SHORT).show();
    ...
    public static void setCurrentPager(int position){
                ...
                switch (position){
                    case  VIEW_FIRST:
                        if(null == mFirstFragment)
                            mFirstFragment = HomeFragment.instance();
                        return mFirstFragment;

                    case VIEW_SECOND:
                        if(null == mSecondFragment)
                            mSecondFragment = MessageFragment.instance();
                        return mSecondFragment;

                    case VIEW_THIRD:
                        if(null == mThirdFragment)
                            mThirdFragment = ContactFragment.instance();
                        return mThirdFragment;

                    case VIEW_FOURTH:
                        if(null == mFourthFragment)
                            mFourthFragment = PersonCenterFragment.instance();
